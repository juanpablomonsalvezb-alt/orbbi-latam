...
const STEPS = [
  { n:'01', title:'Conversamos', body:'Cuéntanos tu caso por el formulario. Entendemos quién eres, qué haces y qué quieres lograr con IA — aplicado exactamente a tu trabajo.', time:'Diagnóstico · 30 min · $40 USD' },
