...
const PROYECTOS = [
  ...
  },
  {
    nombre: 'Sokra',
    url: 'sokraap.com',
    href: 'https://www.sokraap.com',
    tag: 'Aprendizaje socrático con IA',
    headline: 'Piensa mejor. Aprende más profundo.',
    desc: 'Sokra aplica el método socrático a la era de la inteligencia artificial. En lugar de darte respuestas, te hace las preguntas correctas para que construyas tu propio razonamiento. Para profesionales que quieren profundidad real, no atajos.',
    cta: 'Conocer Sokra →',
    accent: '#8FA8C9',
